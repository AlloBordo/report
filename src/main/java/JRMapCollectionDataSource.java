...
class JRMapCollectionDataSource {
    ...
    private Logger logger = Logger.getLogger(JRMapCollectionDataSource.class);

    public JRMapCollectionDataSource() {
    }
    ...
    void start() {
        try {
            ...
            net.sf.jasperreports.engine.data.JRMapCollectionDataSource dataSource = new net.sf.jasperreports.engine.data.JRMapCollectionDataSource(maps);
