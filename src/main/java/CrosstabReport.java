...
public class CrosstabReport extends JFrame {

    public CrosstabReport(String appTitle) throws SQLException, ClassNotFoundException {
        super(appTitle);
  ...
  /*  public static void main(String[] args) throws SQLException, ClassNotFoundException, InvocationTargetException, InterruptedException {
